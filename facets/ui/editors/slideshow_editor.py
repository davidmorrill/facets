...
from facets.api \
    import HasFacets, View, UItem, HSplit

from facets.ui.image \
    import ImageLibrary

#-------------------------------------------------------------------------------
#  'SlideshowEditorTest' class:
#-------------------------------------------------------------------------------

class SlideshowEditorTest ( HasFacets ):
            ...
            HSplit(
                UItem( 'images',
                       ...
                       editor = SlideshowEditor(
                           selected         = 'selected',
                           image_order      = 'shuffle',
                           frame            = Theme( '@xform:photob?L5s|h40H60',
                                                     content = 5,
                                                     label   = ( -8, -8, 1, 5 ) ),
    ...
    def _images_default ( self ):
        ...
        return glob( r'C:\Assembla\trunk\facets_extra\assets\Facets UI Screenshots\*.png' )


    def _images2_default ( self ):
        return ImageLibrary().catalog[ 'particles' ].image_names

#-- Allow test case to be used with demo framework or view tester tool----------

demo = SlideshowEditorTest

#-- Run the test case (if invoked from the command line) -----------------------

if __name__ == '__main__':
    SlideshowEditorTest().edit_facets()
