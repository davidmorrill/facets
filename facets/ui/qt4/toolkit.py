...
from facets.ui.qt4.adapters.layout \
...
class GUIToolkit ( Toolkit ):
    ...
    def show_help ( self, ui, control ):
        ...
        """
        import facets.ui.qt4.editors.ui_panel
    ...
    def screen_info ( self ):
        ...
        for i in xrange( desktop.numScreens() ):
            ...
            info.append( ( r.x(), r.y(), r.width(), r.height() ) )

        n = desktop.primaryScreen()
        if n > 0:
            info[ n ], info[ 0 ] = info[ 0 ], info[ n ]
    ...
    def screen ( self ):
        ...
        """
        return adapted_control( QApplication.desktop() )
    ...
    def clipboard ( self ):
        ...
        if the_clipboard is None:
            from facets.ui.qt4.adapters.clipboard import QtClipboard
    ...
    def color_facet ( self, *args, **facets ):
        ...
        return color_facet.PyQtColor( *args, **facets )


    def rgb_color_facet ( self, *args, **facets ):
        import rgb_color_facet

        return rgb_color_facet.RGBColor( *args, **facets )


    def font_facet ( self, *args, **facets ):
        import font_facet

        return font_facet.PyQtFont( *args, **facets )

    #-- 'EditorFactory' Factory Methods ----------------------------------------

    # Code:
    def code_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.code_editor as ce
    ...
    def directory_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.directory_editor as de
    ...
    def drop_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.drop_editor as de
    ...
    def enum_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.enum_editor as ee
    ...
    def file_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.file_editor as fe
    ...
    def font_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.font_editor as fe
    ...
    def grid_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.grid_editor as ge
    ...
    def html_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.html_editor as he
    ...
    def image_enum_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.image_enum_editor as iee
    ...
    def list_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.list_editor as le
    ...
    def list_str_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.list_str_editor as lse
    ...
    def ordered_set_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.ordered_set_editor as ose
    ...
    def plot_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.plot_editor as pe
    ...
    def tree_editor ( self, *args, **facets ):
        import facets.ui.qt4.editors.tree_editor as te
