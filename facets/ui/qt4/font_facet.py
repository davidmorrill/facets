"""
Facet definition for a PyQt-based font.
"""
...
class FacetPyQtFont ( FacetHandler ):
...
#-------------------------------------------------------------------------------
#  Define a PyQt specific font facet:
#-------------------------------------------------------------------------------

PyQtFont = Facet( FacetsFont(), FacetPyQtFont(), editor = FontEditor )
