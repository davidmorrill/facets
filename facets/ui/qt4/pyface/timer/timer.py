"""
Defines a Timer class that allow functions or methods to be executed at some
later time on the GUI thread.
"""
...
class Timer ( QtCore.QTimer ):
    """ Simple subclass of QTimer that allows the user to have a function called
        periodically.  Some code assumes that this is a sub-class of wx.Timer,
        so we add a few wrapper methods to pretend it is.

        Any exceptions raised in the callable are caught.  If `StopIteration` is
        raised the timer stops.  If other exceptions are encountered the timer
