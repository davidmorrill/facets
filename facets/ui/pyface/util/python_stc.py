"""
Defines a Python wrapper for the wx.StyledTextCtrl class.
"""
...
#-- Handle wx Platform Dependencies --------------------------------------------
...
class PythonSTC ( stc.StyledTextCtrl ):
    ...
    def OnKeyPressed ( self, event ):
        ...
        # KeyCode used to be a method. Now it is an integer. Handle either case:
