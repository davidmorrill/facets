...
**facets.core.has_dynamic_view** module.
"""
...
class DelegatingHandler ( Handler ):
    ...
    def init ( self, info ):
        """ Initializes the controls of a user interface.
            ...
            created, but before the user interface is displayed. Use this method
            to further customize the user interface before it is displayed.
        ...
        # object in the UI's context, create a facet notification handler that
        # will call the method whenever object's 'name' facet changes.
        ...
        for h in self.sub_handlers:
            ...
            for name in self._each_facet_method( h ):
                if name[-8:] == '_changed':
                    prefix = name[ : -8 ]
                    col    = prefix.find( '_', 1 )
                    if col >= 0:
                        ...
                        if object is not None:
                            ...
                            self._dispatchers.append(
                                Dispatcher( method, info, object, facet_name )
                            )
