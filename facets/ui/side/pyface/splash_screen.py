...
class SplashScreen ( MSplashScreen, Window ):
    ...
    def _create_control ( self, parent ):
        ...
        self._side_show_message( splash_screen )
    ...
    def _text_set ( self ):
        ...
        if self.control is not None:
            self._side_show_message( self.control )

    #-- Private Interface ------------------------------------------------------

    def _side_show_message ( self, control ):
        ...
        if self.text_color is None:
            ...
            # Until we get the type of this facet finalised (i.e. when FacetsUI
            # supports Qt) convert it explicitly to a colour.
