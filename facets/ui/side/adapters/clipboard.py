"""
Defines an Qt specific QtClipboard class that provides a concrete implementation
of the Clipboard interface.

The QtClipboard class adapts the Qt clipboard to provide a set of toolkit
...
class QtClipboard ( Clipboard ):
    """ Defines a Qt specific QtClipboard class that provides a concrete
        implementation of the Clipboard interface.

        The QtClipboard class adapts the Qt clipboard to provide a set of
