...
class QtDrag ( Drag ):
    ...
    def _get_has_object ( self ):
        return self.event.mimeData().hasFormat( PyMimeData.MIME_TYPE )
    ...
    def _get_files ( self ):
        ...
        return [ str( url.toString( QUrl.RemoveScheme ) ) for url in urls ]
...
class PyMimeData ( QMimeData ):
    ...
    MIME_TYPE = 'application/x-facets-side-instance'
