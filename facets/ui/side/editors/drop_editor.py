"""
Defines a drop target editor and editor factory for the Qt user interface
toolkit. A drop target editor handles drag and drop operations as a drop target.
"""
...
class DropEditor ( TextEditor ):
    """ Qt editor factory for drop editors.
    """
