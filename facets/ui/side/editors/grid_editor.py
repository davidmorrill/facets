...
from PySide.QtCore \
    import QAbstractTableModel, Qt, QModelIndex, QRect, QPoint, SIGNAL
...
from facets.ui.side.adapters.cell \
    import QtCell
...
class QGridModel ( QAbstractTableModel ):
    ...
    def _data_edit ( self, row, column, screen_row ):
        ...
        """
        return self._editor.grid_adapter.get_content( row, column )
    ...
    def _header_data_display ( self, column ):
        ...
        """
        return self._editor.grid_adapter.get_title( column )
    ...
    def _header_data_text_alignment ( self, column ):
        ...
        """
        return AlignmentMap.get(
            self._editor.grid_adapter.get_alignment( 0, column ), Qt.AlignLeft
        )
    ...
    def _header_data_tooltip ( self, column ):
        ...
        """
        return self._editor.grid_adapter.get_column_tooltip( column )
...
class _QtGridEditor ( _GridEditor ):
    ...
    def _handle_event ( self, method, index ):
        ...
        elif isinstance( result, ViewElement ):
            self._in_popup = True
    ...
    def gui_create_control ( self, parent ):
        ...
        if factory.show_titles:
            sortable       = ('sort' in self.operations)
        ...
        control.setDragDropMode( QAbstractItemView.DragDrop )
        ...
        delegate = QGridDelegate( control.itemDelegate().parent(), self,
                       grid_color, palette.color( QPalette.Highlight ) )
