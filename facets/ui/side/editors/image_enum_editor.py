"""
Defines the various image enumeration editors and the image enumeration editor
factory for the Qt user interface toolkit.
"""
...
class ImageEnumEditor ( EnumEditor ):
    """ Qt editor factory for image enumeration editors.
    """
