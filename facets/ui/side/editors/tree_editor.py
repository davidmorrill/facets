"""
Defines the tree editor and the tree editor factory, for the Qt user interface
toolkit.
"""
...
from facets.ui.side.adapters.graphics \
    import QtGraphics

from facets.ui.side.clipboard \
    import clipboard
...
class TreeEditor ( EditorFactory ):
    """ Qt editor factory for tree editors.
    """
...
class SimpleEditor ( Editor ):
    ...
    def _get_icon ( self, node, object, is_expanded = False ):
        ...
        return QIcon( pixmap_cache( file_name ) )
    ...
    def _object_info ( self, object, name = '' ):
        ...
        expanded, node, _ = self._get_node_data( nid )
    ...
    def _on_tree_sel_modified ( self ):
        ...
        if len( sel ) > 0:
            ...
            for nid in sel:
               ...
               expanded, node, item = self._get_node_data( nid )
    ...
    def _children_replaced ( self, object, facet = '' ):
        ...
        """
        tree                = self._tree
        expanded, node, nid = self._object_info( object, facet )
