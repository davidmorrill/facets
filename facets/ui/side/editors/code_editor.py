"""
Defines a source code editor and code editor factory, for the Qt user interface
toolkit, useful for tools such as debuggers.
"""
...
class CodeEditor ( EditorFactory ):
    """ Qt editor factory for code editors.
    """
