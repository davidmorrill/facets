...
Normally there is a ViewElements object associated with each Facets-based
...
# Facet for contents of a ViewElements object
content_facet = Dict( Str, ViewElement )

#-------------------------------------------------------------------------------
#  'ViewElements' class:
#-------------------------------------------------------------------------------

class ViewElements ( HasStrictFacets ):
    ...
    def _merge ( self, seqs ):
        ...
        while True:
            ...
            for seq in seqs:
                ...
                raise FacetError( 'Inconsistent ViewElements hierarchy' )
...
# Dummy ViewElements object for use with some early loading HasFacets classes
# that end up without one:
dummy_view_elements = ViewElements()

#-------------------------------------------------------------------------------
#  Define forward reference facets:
#-------------------------------------------------------------------------------

ViewElements.add_class_facet( 'parents',       List( ViewElements ) )
ViewElements.add_class_facet( '_search_order', Any )

#-------------------------------------------------------------------------------
#  'SearchStackItem' class:
#-------------------------------------------------------------------------------

class SearchStackItem ( HasStrictFacets ):
