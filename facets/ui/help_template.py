"""
Defines the HTML help templates used for formatting Facets UI help pages.
"""
...
# Default HTML for formatting a Group's 'help' facet
GroupHelp = """
...
class HelpTemplate ( HasStrictFacets ):
