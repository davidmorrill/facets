...
problem cannot be solved solely though the use of carefully chosen facet types
...
from facets.core_api \
    import HasFacets, Range, Float, Bool, Str, Property, property_depends_on
