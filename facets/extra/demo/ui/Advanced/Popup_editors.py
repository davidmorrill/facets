...
clicked on pop up an editor that allows you to modify the associated facet
value.
...
- *info*: The popup is displayed over the the value it is associated with. This
  is similar to 'popover', but the popup will be dismissed when the mouse
