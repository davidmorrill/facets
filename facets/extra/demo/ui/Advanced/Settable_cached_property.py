...
new value into the text entry field. You will see that the 'd' facet updates
as well, illustrating that the 'c' facet can be set directly, as well as
...
Now try typing a value into the 'd' facet and you will see that an error
results (indicated by the text entry field turning red), because this is a
normal 'cached' facet that has no 'setter' method defined.
"""
