"""
ImageCollector: A Facets component tool.
...
Date/Time:
  Saturday, September 10, 2011 at 04:28:18 PM
...
from facets.extra.tools.image_collector \
...
class ImageCollector ( HasPrivateFacets ):
    ...
    tool_2 = Instance( ImageCollector, { 'name': 'Image Collector' } )
    tool_3 = Instance( ImageKnife, { 'name': 'Image Knife' } )
    ...
    def default_facets_view ( self ):
        ...
        return View(
            ...
            title     = 'Image Collector Tool',
            id        = 'facets.extra.tools.tools.generated.ImageCollector',
            resizable = True,
            width     = 0.5,
            height    = 0.323
        )
