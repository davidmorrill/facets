"""
This demonstrates one of the simplest cases of using the Facets file dialog to
...
Facets file dialog are:
 ...
 - There is a very nice synergy between the file system view and the history
   ...
   in the file system when opening files. The Facets file dialog automatically
 ...
 - It's customizable. The Facets file dialog accepts extension objects which
   ...
   Facets (and are demonstrated in some of the other examples), and you are
