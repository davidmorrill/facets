...
from facets.api \
    import HasStrictFacets, Facet, CFloat, Property, View, VGroup, HGroup, Item
...
#-- Units facet maps all units to centimeters ----------------------------------

Units = Facet( 'inches', { 'inches':      2.54,
                           'feet':        ( 12 * 2.54 ),
                           'yards':       ( 36 * 2.54 ),
                           'miles':       ( 5280 * 12 * 2.54 ),
                           'millimeters': 0.1,
...
class Converter ( HasStrictFacets ):
